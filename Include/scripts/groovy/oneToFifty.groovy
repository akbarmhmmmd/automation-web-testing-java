...
import dto.Initialization
import com.kms.katalon.core.configuration.RunConfiguration
import java.util.Random
import dto.Lib_Global
...
public class oneToFifty extends GLOBAL {
    ...
    public void playGame() {
		...
		boolean gridEmpty = driver.findElements(By.id("grid")).isEmpty();
		
		if (gridEmpty) {
			System.out.println("1 to 50 - PASSED");
			WebUI.comment("1 to 50 - PASSED");
		} else {
			System.out.println("1 to 50 - FAILED");
			WebUI.comment("1 to 50 - FAILED")
		}
